            ...
            children: <Widget>[
             Padding(padding: EdgeInsets.only(top: 25.0),
              ...
              Padding(
                ...
                child: Text('Your Current Vehicle', style:
                  TextStyle(
             ...
             height: 175.0,
              ...
              Text('PORSCHE',style: TextStyle(
                fontFamily: 'Oswald',
                fontSize: 30.0,
                fontWeight: FontWeight.bold
              ),),
              Text('2009 - 911 CARRERA S',style: TextStyle(
                  fontFamily: 'Oswald',
                  fontSize: 14.0,
                  fontWeight: FontWeight.bold,
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          SizedBox(height: 5.0),
                          Text('19/24',style: TextStyle(fontFamily: 'Oswald',
                          fontSize: 20.0,
                            fontWeight: FontWeight.bold
                          ),)
                        ],
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          SizedBox(height: 5.0),
                          Text('3.2',style: TextStyle(fontFamily: 'Oswald',
                              fontSize: 20.0,
                              fontWeight: FontWeight.bold
                          ),)
                        ],
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          SizedBox(height: 5.0),
                          Text('443',style: TextStyle(fontFamily: 'Oswald',
                              fontSize: 20.0,
                              fontWeight: FontWeight.bold
                          ),)
                        ],
              ...
              Row(
                children: <Widget>[
                  ...
                  style: TextStyle(color: Color(0xFF434C68).withOpacity(0.7),
                  fontWeight: FontWeight.bold,
                    fontSize: 17.0,
                    fontFamily: 'Oswald'
                  ),
